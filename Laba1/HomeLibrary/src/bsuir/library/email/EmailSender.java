...
public class EmailSender {
	...
	public static void sendEmail(Address[] recipeints, Book book) throws EmailException {
		...
		Session session = Session.getDefaultInstance(properties,
			...
			try {
				...
				mess.setSubject("Описание книги");
				mess.setText("Здравствуйте! В библиотеке появилось описание для книги: "+book.getName()+"  ");
				Transport.send(mess);
	...
	public static void sendEmailWithBook(String locationOfBook,String userEmail, String adminEmail) throws EmailException {
		...
		try {
			...
			message.setSubject("Предложение о добавлении книги в библиотеку");
		
			BodyPart messageBodyPart1 = new MimeBodyPart();
			messageBodyPart1.setText("Здравствуйте!Хотел(а) бы видеть в вашей библиотеке эту книгу");
